...
def record():
    if request.method == "POST":
        ...
        for i in range(len(semester)):
            ...
            subject.append(subjects[0]["subject"])
            ...
            target.append(subject[0]["target"])
            asms = []
            asm1 = db.execute("""SELECT asm1 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm1[0]['asm1'])
            asm2 = db.execute("""SELECT asm2 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm2[0]['asm2'])
            asm3 = db.execute("""SELECT asm3 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm3[0]['asm3'])
            asm4 = db.execute("""SELECT asm4 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm4[0]['asm4'])
            asm5 = db.execute("""SELECT asm5 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm5[0]['asm5'])
            asm6 = db.execute("""SELECT asm6 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            asms.append(asm6[0]['asm6'])
            asm.append(asms)
            subscores = []
            score1 = db.execute("""SELECT score1 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score1[0]['score1'])
            score2 = db.execute("""SELECT score2 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score2[0]['score2'])
            score3 = db.execute("""SELECT score3 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score3[0]['score3'])
            score4 = db.execute("""SELECT score4 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score4[0]['score4'])
            score5 = db.execute("""SELECT score5 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score5[0]['score5'])
            score6 = db.execute("""SELECT score6 FROM records WHERE user_id=:user_id AND semester=:semester""", user_id=session["user_id"], semester = semester[i]["semester"])
            subscores.append(score6[0]['score6'])
