...
def schedule():
    if request.method == "POST":
        ...
        if asm1 is None:
            ...
            db.execute("""UPDATE schedule SET assignment1=:assignment1, due1=:due1, weight1=:weight1, assignment2=:assignment, due2=:due2, weight2=:weight2,
            assignment3=:assignmrnt3, due3=:due3, weight3=:weight3, assignment4=:assignment4, due4=:due4, weight4=:weight4, assignment5=:assignment, due5=:due5,
            weight5=:weight5, assignment6=:assignment6, due6=:due, weight6)
        ...
        return render_template("schedule.html", subjects = subjects, course = course)
    else:
        course = db.execute("""SELECT subject, code, assignment1, assignment2, assignment3, assignment4, assignment5, assignment6 FROM schedule
        WHERE user_id=:user_id""", user_id=session["user_id"])
