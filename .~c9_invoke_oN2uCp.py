...
def login():
    if request.method == "POST":
        ...
        subjects = db.execute("""SELECT subject FROM schedule WHERE user_id=:user_id""", user_id=session["user_id"])
    ...
    if request.method == "POST":
        ...
        if asm1 is None:
            ...
            if subject is None:
                ...
                return redirect("/schedule")
            db.execute("""UPDATE schedule SET assignment1=:assignment1, due1=:due1, weight1=:weight1, assignment2=:assignment2, due2=:due2, weight2=:weight2,
                assignment3=:assignment3, due3=:due3, weight3=:weight3, assignment4=:assignment4, due4=:due4, weight4=:weight4, assignment5=:assignment5, due5=:due5,
                weight5=:weight5, assignment6=:assignment6, due6=:due6, weight6=:weight6
        ...
        due1 = db.execute("""SELECT due1 FROM schedule WHERE user_id=:user_id AND id=:id""", user_id=session["user_id"], id = i)
        due2 = request.form.get("due2")
        due3 = request.form.get("due3")
        due4 = request.form.get("due4")
        due5 = request.form.get("due5")
